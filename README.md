...
<p align="center">
  <a href="https://pypi.org/project/havfrys/"><img src="https://img.shields.io/pypi/v/havfrys.svg?style=for-the-badge&logo=pypi&logoColor=white&color=00f0ff" alt="PyPI Package"></a>
  <a href="https://pypi.org/project/havfrys/"><img src="https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12%20%7C%203.13-3776ab.svg?style=for-the-badge&logo=python&logoColor=white" alt="Python Versions"></a>
...
HAVFRYS is evaluated on real production repositories facing breaking ecosystem migrations. See [DOGFOODING.md](DOGFOODING.md) for the full 10-repository case study matrix across Python 3.14, Pydantic V2, Django, Prefect, and GraphQL stacks.
...
HAVFRYS is released under the **[Business Source License 1.1 (BUSL-1.1)](LICENSE)**.
